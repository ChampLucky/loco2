...
<%@page import="tour.pojo.GetBooking"%>
<%@page import="java.util.ArrayList"%>
<%@page import="tour.Dao.getBookingDao"%>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="container">
		...
		<nav class="py-md-4 py-3 d-lg-flex">
			...
			<ul class="menu ml-auto mt-1">
				<!--<li class="active"><a href="newcustomer.jsp">Home</a></li>-->
				<li class="active"><a href="yourTour.jsp">Your Tours</a></li>
				<li class=""><a href="customer.jsp?p_id=0">Book Tour</a></li>
...
<%
getBookingDao d=new getBookingDao();

int n=d.numberOfBookings(c_id);
...
ArrayList<GetBooking> bookings=d.getListOfBookings(c_id);


%>

   <section class="about py-5">
    <% for(GetBooking booking :bookings){ %>

	<div class="container py-lg-5 py-sm-4">
		<div class="row">
			<div class="col-lg-6 about-left">
                             <%
                                    getPackageDao pk=new getPackageDao();
                                    GetPackage a=pk.packagePerId(booking.getP_id());
                                %>
				<h3 class="mt-lg-3">Category: <% out.println(a.getCategory());%></h3>
                               
				<p class="mt-4">Places: <% out.println(a.getDescription());%></p>
                                <p class="mt-4">Tour Date: <% out.println(booking.getTour_date());%></p>
                                <p class="mt-4">Booking Date: <% out.println(booking.getBooking_date());%></p>
                                 <% int p_id=a.getP_id();%>
			...
			<div class="col-lg-6 about-right text-lg-right mt-lg-0 mt-5">
				<img src="images\<% out.println(a.getP_image());%>" alt="" class="img-fluid abt-image" />
                                ...
                                <a href="customer.jsp?p_id=<%out.println(a.getP_id());%> ">Book now</a>
                                </div>
	</div>
...
<%} %>
 ...
 <h1 class="my-5 py-10">you have not visited any places, ${c_name}. please choose a package first.</h1>
